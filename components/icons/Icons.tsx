...
export const ShareIcon = (props: IconProps) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.042.583.042h6a2.25 2.25 0 012.25 2.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 01-1.125-1.125V14.5m0-3.375c.656.002 1.312.002 1.968.002h2.188a2.25 2.25 0 110-4.5H9.188a2.25 2.25 0 000 4.5z" />
    </svg>
);
